\question \textbf{Hashing - Linear Probing}
Consider the two situations in a hash table of size m using open addressing with linear
probing:

\begin{parts}
\part You have $n = m/2$ keys in the table, where every even-indexed slot is occupied and
...
\part You have $n = m/2$ keys in the table and the first n = m/2 locations are the ones
occupied.
